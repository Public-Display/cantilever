  ...
  return (
    <div className='w-full h-[100dvh] bg-primary-100 flex flex-col items-start md:flex-row md:items-center justify-between'>
      ...
      <div className='w-full md:w-3/5 flex items-start justify-start flex-col space-y-3 p-8 z-10 pt-[152px] md:pt-0'>
        ...
        <p className='text-4xl md:text-8xl text-white w-full body-font font-cinzel'>
          WEBSITE COMING SOON
        </p>
      ...
      <div 
        ...
        className='overflow-hidden h-full md:min-h-[120dvh] w-full md:w-2/5 flex items-center justify-end absolute md:relative text-white'
      >
        <div className='absolute left-0 md:right-24 pl-8 pt-72 md:pt-0 md-pl-0 opacity-100 md:left-2/3 flex items-center justify-center flex-col text-white'>
          ...
          <div className='text-6xl md:text-8xl font-bold text-white flex items-center space-x-2 body-font font-albert'>
          ...
          <p className='text-2xl md:text-4xl text-white body-font font-albert font-normal uppercase'>Days</p>
        </div>
      </div>
